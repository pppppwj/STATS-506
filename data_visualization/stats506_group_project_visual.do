...
*graph bar fat_nd fat_d sugar_nd sugar_d carbohydrate_nd carbohydrate_d , by(age gender insurance1) 

*graph bar sugar_nd sugar_d, by(age gender insurance1) bargap(-50) legend(label(1 "Mean Sugar (ND)") label(2 "Mean Sugar (D)")) 

*graph bar carbohydrate_nd carbohydrate_d, by(age *gender insurance1) stack
* Need to Fix Legend and decide what to do with y-axis - Fixed.
